...
if ( class_exists( 'QiAddonsForElementor_List_Shortcode' ) ) {
	class QiAddonsForElementor_Clients_List_Shortcode extends QiAddonsForElementor_List_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_documentation( 'https://qodeinteractive.com/qi-addons-for-elementor/documentation/#5_clients_list' );
			...
			$this->set_option(
				array(
					...
					'selectors'  => array(
						...
						'{{WRAPPER}} .qodef-border--all .qodef-grid-inner' => 'border-color: {{VALUE}};',
					),
					'dependency' => array(
						'hide' => array(
							'enable_border' => array(
			...
			$this->set_option(
				array(
					...
					'selectors'  => array(
						...
						'{{WRAPPER}} .qodef-border--all .qodef-grid-inner' => 'border-style: {{VALUE}};',
					),
					'dependency' => array(
						'hide' => array(
							'enable_border' => array(
			...
			$this->set_option(
				array(
					...
					'selectors'  => array(
						...
						'{{WRAPPER}} .qodef-border--all .qodef-grid-inner' => 'border-width: {{SIZE}}{{UNIT}};',
